...
const PrimaryBtn = styled.button`
  ...
  &:hover:not(:disabled) { filter: brightness(1.06); box-shadow: 0 10px 28px color-mix(in srgb, var(--c-accent) 40%, transparent); }
`;
const ErrorLine = styled.p`margin: 12px 0 0; font-size: 12.5px; color: ${C.danger};`;
const Spin = styled.span`
  width: 15px; height: 15px; border: 2px solid rgba(14,20,15,0.3); border-top-color: ${C.accentInk};
