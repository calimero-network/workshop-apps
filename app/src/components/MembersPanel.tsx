...
import { C } from '../theme';
import { Primary } from './primitives';
...
const Head = styled.div`
  ...
  font-size: var(--c-text-base); color: ${C.muted};
`;
const Invite = styled(Primary)`
  padding: var(--c-space-2) var(--c-space-3);
`;
const List = styled.ul`list-style: none; margin: var(--c-space-2) 0 0; padding: 0;`;
const Defaults = styled.div`
  display: flex; align-items: center; gap: var(--c-space-3); margin-top: var(--c-space-3);
  label { font-size: var(--c-text-sm); color: ${C.muted}; }
`;
