  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h3 style={{ marginBottom: '1rem' }}>New Circle</h3>
        <p style={{ color: '#888', fontSize: '0.8rem', marginBottom: '0.5rem' }}>
          Name your collector circle — invite trusted peers to start trading after it's created.
        </p>
        <input
          autoFocus
          type="text"
          ...
          placeholder="Circle name (e.g. Vintage Watch Club)"
          style={{
