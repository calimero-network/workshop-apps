  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h3 style={{ marginBottom: '1rem' }}>New Conversation</h3>
        <p style={{ color: '#888', fontSize: '0.8rem', marginBottom: '0.5rem' }}>
          Give this conversation a name, then invite your friend using the "Invite friend" button.
        </p>
        <input
          autoFocus
          type="text"
          ...
          placeholder="e.g. Chat with Alice"
          style={{
