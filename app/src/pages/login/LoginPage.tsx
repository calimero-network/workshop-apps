  ...
  return (
    <div className="app-bg">
      <div className="page-shell" style={{ justifyContent: 'center', alignItems: 'center', gap: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 700 }}>Habit Streak Board</h1>
        <p style={{ color: '#888', maxWidth: 400, textAlign: 'center' }}>
          Track daily habits together with friends, build streaks, and cheer
          each other on \u2014 all on your own decentralized node.
        </p>
        <ConnectButton />
        <Button
          variant="secondary"
