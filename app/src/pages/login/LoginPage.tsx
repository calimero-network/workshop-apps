  ...
  return (
    <div className="app-bg">
      <div className="page-shell" style={{ justifyContent: 'center', alignItems: 'center', gap: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 700, color: 'var(--color-primary, #3B82F6)' }}>
          Team Todo
        </h1>
        <p style={{ color: '#888', maxWidth: 400, textAlign: 'center' }}>
          Shared team task list powered by Calimero. Add tasks, mark them done,
          and keep your whole team in sync — with end-to-end privacy.
        </p>
        <ConnectButton />
        <Button
          variant="secondary"
