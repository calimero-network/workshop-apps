  ...
  return (
    <div className="app-bg">
      <div className="page-shell" style={{ justifyContent: 'center', alignItems: 'center', gap: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 700 }}>Team Todos</h1>
        <p style={{ color: '#888', maxWidth: 400, textAlign: 'center' }}>
          A shared, decentralized task list for your team. Add tasks, mark
          them done, and collaborate in real time — all on your own node.
        </p>
        <ConnectButton />
        <Button
          variant="secondary"
