  ...
  return (
    <div className="app-bg">
      <div className="page-shell" style={{ justifyContent: 'center', alignItems: 'center', gap: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 700 }}>Team Expenses</h1>
        <p style={{ color: '#888', maxWidth: 400, textAlign: 'center' }}>
          Decentralized expense tracking powered by Calimero. Submit expenses,
          review and approve as a team, and track reimbursements — all on nodes you control.
        </p>
        <ConnectButton />
        <Button
          variant="secondary"
