  ...
  return (
    <div className="app-bg">
      <div className="page-shell" style={{ justifyContent: 'center', alignItems: 'center', gap: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 700 }}>Group Vote</h1>
        <p style={{ color: '#888', maxWidth: 400, textAlign: 'center' }}>
          Collaborative ranked voting powered by Calimero. Create votes,
          invite participants, and make group decisions with full privacy.
        </p>
        <ConnectButton />
        <Button
          variant="secondary"
