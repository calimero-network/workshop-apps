  ...
  return (
    <div className="app-bg">
      <div className="page-shell" style={{ justifyContent: 'center', alignItems: 'center', gap: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 700 }}>deal-flow</h1>
        <p style={{ color: '#888', maxWidth: 400, textAlign: 'center' }}>
          A decentralized sales pipeline for small teams. Track leads, customize
          stages, and close deals — all in real time, on your own node.
        </p>
        <ConnectButton />
        <Button
          variant="secondary"
