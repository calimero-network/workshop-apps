  ...
  return (
    <div className="app-bg">
      <div className="page-shell" style={{ justifyContent: 'center', alignItems: 'center', gap: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 700 }}>Team Todo List</h1>
        <p style={{ color: '#888', maxWidth: 400, textAlign: 'center' }}>
          Shared, decentralized task tracking for your team — add tasks, assign
          owners, and track progress together in real time, with no central server.
        </p>
        <ConnectButton />
        <Button
          variant="secondary"
