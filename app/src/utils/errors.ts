 ...
 *
 * Our contract errors (`ChatError`) serialize as `{ kind, data }`, e.g.
 ...
 * human-readable string, e.g. "Forbidden: delete_room: caller is not a room
 * moderator".
 */
...
function extractDetail(data: unknown): string | null {
  ...
  if (typeof data === 'object') {
    ...
    // ChatError serde shape: { kind: "Forbidden", data: "…" }
