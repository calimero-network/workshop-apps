...
/**
 * The wire service name of the primary (or sole) service.
 * Used as a safe fallback for single-service apps where `SERVICE_NAME.directory`
 * is not declared in studio.config.json (no `id` field on the service entry).
 */
