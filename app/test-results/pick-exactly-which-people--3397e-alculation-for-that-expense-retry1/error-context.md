...
- Name: pick-exactly-which-people-are-part-of-a-.spec.ts >> member: pick exactly which people are part of a given expense >> only the members selected as participants on an expense are reflected in the balance calculation for that expense
- Location: e2e/pick-exactly-which-people-are-part-of-a-.spec.ts:42:3
