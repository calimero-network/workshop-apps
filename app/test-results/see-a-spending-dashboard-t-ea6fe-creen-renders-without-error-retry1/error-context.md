...
- Name: see-a-spending-dashboard-total-spent-and.spec.ts >> anyone in the group: see a spending dashboard — total spent and each person's paid and owed share >> post-auth screen renders without error
- Location: e2e/see-a-spending-dashboard-total-spent-and.spec.ts:36:3
