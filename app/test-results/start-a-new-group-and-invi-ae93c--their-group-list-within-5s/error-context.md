...
- Name: start-a-new-group-and-invite-my-friends-.spec.ts >> group creator: start a new group and invite my friends into it >> after the creator names the group and confirms, every invited member sees the group in their group list within 5s
- Location: e2e/start-a-new-group-and-invite-my-friends-.spec.ts:35:3
