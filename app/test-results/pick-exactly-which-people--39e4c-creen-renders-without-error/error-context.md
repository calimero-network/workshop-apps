...
- Name: pick-exactly-which-people-are-part-of-a-.spec.ts >> member: pick exactly which people are part of a given expense >> post-auth screen renders without error
- Location: e2e/pick-exactly-which-people-are-part-of-a-.spec.ts:36:3
