...
- Name: dm.spec.ts >> DM: roll a d20 for a player ability check >> after the DM rolls for a player, the result (d20 + ability modifier = total) appears in the shared log within 2s
- Location: e2e/dm.spec.ts:95:3
