...
- Name: start-a-new-group-and-invite-my-friends-.spec.ts >> group creator: start a new group and invite my friends into it >> post-auth screen renders without error
- Location: e2e/start-a-new-group-and-invite-my-friends-.spec.ts:20:3
