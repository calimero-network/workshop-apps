...
- Name: mark-a-debt-as-settled-when-someone-pays.spec.ts >> anyone in the group: mark a debt as settled when someone pays back what they owe >> post-auth screen renders without error
- Location: e2e/mark-a-debt-as-settled-when-someone-pays.spec.ts:43:3
