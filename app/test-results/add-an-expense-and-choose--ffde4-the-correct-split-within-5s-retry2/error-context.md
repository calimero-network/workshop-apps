...
- Name: add-an-expense-and-choose-how-to-split-i.spec.ts >> member: add an expense and choose how to split it — equally among selected members, or fully owed by one specific person >> after a member adds an expense, every other member of the group sees it in the expense list with the correct split within 5s
- Location: e2e/add-an-expense-and-choose-how-to-split-i.spec.ts:43:3
