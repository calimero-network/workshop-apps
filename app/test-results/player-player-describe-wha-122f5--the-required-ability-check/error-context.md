...
- Name: player.spec.ts >> player: describe what my character is doing >> after a player posts an action, the DM sees it in the chat and can roll the required ability check
- Location: e2e/player.spec.ts:85:3
