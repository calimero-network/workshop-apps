...
- Name: dm.spec.ts >> DM: roll dice for NPCs and monsters >> after the DM rolls for an NPC, the d20 result appears in the chat and everyone sees what the monster rolled
- Location: e2e/dm.spec.ts:133:3
