...
- [ ] Define entity: [counter] Counter (id:LwwRegister<String>, total:Counter<u64>, last_incremented_by:LwwRegister<String>, last_increment_at:LwwRegister<u64>)
- [ ] Implement mutate: [counter] increment() → app::Result<u64>
- [ ] Implement mutate: [counter] reset() → app::Result<()>
- [ ] Implement view: [counter] get_counter() → app::Result<Counter>
