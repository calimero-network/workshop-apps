...
- [ ] Define entity: [todolist] Task (id:LwwRegister<String>, title:LwwRegister<String>, author:LwwRegister<String>, assigned_to:LwwRegister<Option<String>>, completed:LwwRegister<bool>, created_at:LwwRegister<u64>)
- [ ] Implement mutate: [todolist] create_task(title: String) → app::Result<String>
- [ ] Implement view: [todolist] list_tasks() → app::Result<Vec<Task>>
- [ ] Implement mutate: [todolist] mark_complete(task_id: String) → app::Result<()>
- [ ] Implement mutate: [todolist] mark_incomplete(task_id: String) → app::Result<()>
- [ ] Implement mutate: [todolist] edit_task(task_id: String, new_title: String) → app::Result<()>
- [ ] Implement mutate: [todolist] delete_task(task_id: String) → app::Result<()>
- [ ] Implement mutate: [todolist] assign_task(task_id: String, assignee: String) → app::Result<()>
